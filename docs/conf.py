...
#
# JSONAlchemy documentation build configuration file, created by
...
htmlhelp_basename = 'JSONAlchemydoc'
...
latex_documents = [
  ('index', 'JSONAlchemy.tex', u'JSONAlchemy Documentation',
...
man_pages = [
    ('index', 'invenioqueryparser', u'JSONAlchemy Documentation',
...
texinfo_documents = [
  ('index', 'JSONAlchemy', u'JSONAlchemy Documentation',
   u'Invenio collaboration', 'JSONAlchemy', 'One line description of project.',
   'Miscellaneous'),
]
